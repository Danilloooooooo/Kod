...
background = transform.scale(image.load("mirage.jpg"), (width, height))

hp1 = transform.scale(image.load("cer2.png"), (125, 70))
hp2 = transform.scale(image.load("cer1.png"), (125, 70))
hp3 = transform.scale(image.load("cer.png"), (125, 70))
num_hp = 3
...
player = Player("bb.png", 350, 425, 50, 50, 10)
killall = Bonus("choma1.png", randint(0, width - 80), 0, 50, 50, 3)
monsters = sprite.Group()
bonuses = sprite.Group()
killall.add(bonuses)
random_enemy = ["ss.png", "ch.png"]
for i in range(6):  
    monster = Enemy(choice(random_enemy)  , randint(0, width - 80), -40, 50, 50, randint(1, 4))
...
while game:
    if num_hp >= 0:
        ...
        window.fill((0,0,0))
        num = font2.render("Ты проиграл:( ", 0, (255, 103, 0))
